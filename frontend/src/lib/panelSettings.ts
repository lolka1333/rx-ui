...
export function mergePanelSettings(
  ...
  return {
    ...
    xray_freedom_block_delay:
      current?.xray_freedom_block_delay ?? XRAY_DEFAULTS.xray_freedom_block_delay,
    ...
    xray_direct_ips: current?.xray_direct_ips ?? XRAY_DEFAULTS.xray_direct_ips,
